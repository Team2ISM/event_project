{
    ...
    "dimensions": "Размеры", 
    "download": "Скачать", 
    "dz_dictDefaultMessage": "Перетащите сюда файлы для загрузки", 
    "dz_dictFallbackMessage": "Your browser does not support drag'n'drop file uploads.", 
    "dz_dictInvalidFileType": "Вы не можете загружать файлы этого типа.", 
    ...
    "successful_replace": "Файл успешно перемещён.", 
